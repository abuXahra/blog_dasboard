...
import { HamburgerWrapperHeader, HeaderContent, HeadWrapper, IconWrapper, NotificationWrapper, ProfileWrapper, SearchContainer } from './Header.style'
...
export default function HeaderDashboard({showSidebar}) {
