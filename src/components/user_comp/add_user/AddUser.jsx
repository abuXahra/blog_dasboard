...
import { AddUserPostForm, AddUserPostWrapper, AdsImage, ErrorMessage, InputWrapper, PostPicture, Select } from './AddUser.style';
...
export default function AddUser({setCloseOverlay, closeOverlayOnClick}) {
  ...
  return (   
    <AddUserPostWrapper>
        <AddUserPostForm onSubmit={handleSubmit}>
    <Overlay
        contentHight={"auto"}
        contentWidth={"50%"}
